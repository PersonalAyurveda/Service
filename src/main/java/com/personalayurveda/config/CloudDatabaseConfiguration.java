package com.personalayurveda.config;
...
@Configuration
@EnableMongoRepositories("com.personalayurveda.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.personalayurveda.config.dbmigrations");
